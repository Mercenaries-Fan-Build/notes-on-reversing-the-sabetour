...
- [vmx128-xenon-decomp](vmx128-xenon-decomp.md) — ★VMX128 (Xbox360 Xenon vector ISA) encodings = enabler to fully DECOMP the symbol-rich prototype .xex (Ghidra XEX + SLEIGH VMX128 + PDB import). Richer oracle than the .map. Ref: biallas.net/doc/vmx128. Verify vs PC.
