...
**Full Ghidra decomp = the oracle:** 36,935 entries (35,819 `FUN_*` + 1,116 demangled/synthetic names), ⚠️ **in the SIBLING repo** at `C:/Users/Shadow/Desktop/notes-on-the-released-game/output/_ghidra_saboteur/saboteur_all_functions_decomp.txt` — NOT under this repo, despite what the old relative path implied (54 MB, gitignored, regenerate via tools/ghidra/DecompileSaboteur.java). Because the exe is unpacked, the decomp authoritatively shows how any format is parsed/produced — grep it before speculating.
