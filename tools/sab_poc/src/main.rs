...
fn main() {
    ...
    let r = match cmd.as_str() {
        ...
        "50cent" => mesh::retarget_50cent(&flags),
        "50cent-parts" => mesh::parts_50cent(&flags),
        "50cent-encode" => mesh::encode_50cent(&flags),
        "50cent-tex" => mesh::textures_50cent(&flags),
        "50cent-deploy" => deploy::deploy_50cent(&flags),
