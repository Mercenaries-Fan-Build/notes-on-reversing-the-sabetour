...
| `Render.FadeScreen` | `0x0073e730` | adapter | `(bFade:boolean) -> ()` — **arg 2 ignored** | confirmed | exe; `FUN_006f7120(1)` @`0x73e771` → `FUN_006f6e60(1)` → `[0x12e85c4]->FUN_00652690(b, 1)`; `false` also clears `(DAT_014a9d78+0x15c) & 0xfe`. 60 direct / 7 bare; **32 files contain a direct call, 34 mention the name at all** (*clarified 2026-07-24*) |
